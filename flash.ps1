...
Write-Host "Flashing algae-medium-monitor.hex to Arduino Pro Mini on $env:AVR_COM_PORT..."
...
if ($LASTEXITCODE -eq 0) {
    ...
    avrdude -p atmega328p -c arduino -P $env:AVR_COM_PORT -b 57600 -D -U flash:w:target\avr-atmega328p\release\algae-medium-monitor.hex:i
